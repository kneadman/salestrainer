...
from app.domain.judgement_models import JudgeSessionInput, JudgeSessionOutput, build_judge_input_from_session
...
class JudgementService:
    ...
    def judge_session(self, session: TrainingSessionState) -> TokenCountedResult[JudgeSessionOutput]:
