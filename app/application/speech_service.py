...
from app.domain.errors import SpeechTranscriptionError, SpeechUploadTooLargeError, UnsupportedAudioTypeError
...
class SpeechService:
    ...
    def _validate_duration(self, duration_ms: int | None) -> None:
