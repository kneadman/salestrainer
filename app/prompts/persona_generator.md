...
- `persona.company_size` — **строка**, например `"28 сотрудников"` или `"малый бизнес, 15 человек"`. **НЕ число** `28`.
...
"business_facts": [
  ...
  "15 сотрудников, оборот 82 млн руб."
]
```
...
```json
"business_facts": "Оптовая торговля, 15 сотрудников"
```

```json
"business_facts": "- Оптовая торговля\n- 15 сотрудников"
```
