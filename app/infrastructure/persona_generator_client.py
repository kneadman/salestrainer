...
class FakePersonaGeneratorClient:
    def __init__(self, generator: PersonaGenerator | None = None) -> None:
        """Keep the legacy Python generator available as fake/debug persona generation."""
        self._generator = generator or PersonaGenerator()
    ...
    def generate_persona(self, payload: PersonaGenerationInput) -> PersonaGenerationOutput:
        ...
        return PersonaGenerationOutput(
            ...
            policy_coverage=["product_line", "persona_policy"],
            risk_flags=[],
        )
    ...
    def _policy_overrides(self, payload: PersonaGenerationInput) -> dict[str, object]:
        ...
        if payload.allowed_product_lines:
            overrides["allowed_product_lines"] = payload.allowed_product_lines
