"""Shared plumbing for OpenAI/Yandex-compatible responses-API clients.
...
``openai.OpenAI`` transport. Client-specific request building, retry loops,
...
class OpenAICompatibleResponsesClient:
    """Shared transport base for OpenAI/Yandex-compatible responses-API clients."""
